...
)  # (cov19/config/settings/base.py - 3 = cov19/)
APPS_DIR = ROOT_DIR.path("cov19")
...
MIGRATION_MODULES = {"sites": "cov19.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "cov19.utils.context_processors.settings_context",
            ],
        },
    }
]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = "Support COV19 <support@virusmodels.org>"
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "cov19.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "cov19.users.adapters.SocialAccountAdapter"
